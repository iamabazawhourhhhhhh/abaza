--[[
الالعاب ل سورس هيل
تم تعديل الملف واضافه الالعاب من قبل باسل
--]]
local function game(msg,MsgText)
if msg.type ~= "pv" then
...
if MsgText[1] == 'الالغاز' or MsgText[1] == 'لغز' then
  ...
  name = katu[math.random(#katu)]
  redis:set(ws..':Set_lgz:'..msg.chat_id_,name)
...
Num = math.random(1,6)
redis:set(ws.."game"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
redis:set(ws.."game:NUM"..msg.chat_id_,Num) 
...
return 'اول من يكتب ذي يفوز ⬅︎`'..(redis:get(ws..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️اول من يكتب ذي يفوز ⬅︎    `'..(redis:get(ws..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
if msg.text == redis:get(ws..':Set_lgz:'..msg.chat_id_) then -- // لغز
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_lgz:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• أحسنت حليت اللغز   \n*   \n')
end

if msg.text == redis:get(ws..':Set_lgz:'..msg.chat_id_) then -- // الالغاز
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_lgz:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• أحسنت حليت اللغز   \n*   \n')
end

if msg.text == redis:get(ws..':Set_Amthlh:'..msg.chat_id_) then -- // رياضيات
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_Amthlh:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• أحسنت حليت المسائله الصحيحه   \n*   \n')
end

if msg.text == redis:get(ws..':Set_Amthlh:'..msg.chat_id_) then -- // تركيب
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_Amthlh:'..msg.chat_id_)
...
if msg.text == redis:get(ws..':Set_Amthlh:'..msg.chat_id_) then -- // تفكيك
redis:incrby(ws..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(ws..':Set_Amthlh:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*• أحسنت فككتها صح   \n*   \n')
end
...
return false  end 
local GETNUM = redis:get(ws.."game"..msg.chat_id_)
...
return false  end 
local GETNUM = redis:get(ws.."game:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
