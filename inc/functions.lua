...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(ws..":NameBot:") or "الزعيم"
...
usernn = data.username_ or "vvvvisn"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "vvvvisn"
end
Name = Name:gsub('[[][]]','')
...
local Fshar_Word , res = https.request('https://api.th3ws.com/Words_Fshars.txt')
...
Fshar_Word , res = https.request('https://api.th3ws.com/Words_Fshars.txt')
if res ~= 200 then Fshar_Word = "\n" end
...
var = 'هذا البوت 🙄☝🏿' 
elseif UserID == 1399282735 or UserID == 656329268  then 
var = 'مطور السورس'
...
message = message ..i.. '-l ['..info.username..'](t.me/vvvvisn) \n'
end
...
message = message ..k.. '-l ['..info.username..'](t.me/vvvvisn) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/vvvvisn) l » (`' ..v.. '`) \n'
end
end
end
...
if UserID == 1399282735 or UserID == 656329268 then return sendMsg(ChatID,MsgID,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
