...
https.request('https://api.th3LANA.com/request/?insert='..JSON.encode(info))
...
msg.TheRank = redis:get(LANA..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي 👨🏻‍✈️' 
msg.Rank = 1
...
msg.TheRank = redis:get(LANA..":RtbaNew5:"..msg.chat_id_) or 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
