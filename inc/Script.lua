...
if UserID == 656329268then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 656329268then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
{{text = '-𝙏𝙒𝘼𝙎𝙊𝙇 💬 ',url="https://t.me/bossxbot"}},
}   
return send_inline(msg.chat_id_,text,inline,msg.id_)
end
