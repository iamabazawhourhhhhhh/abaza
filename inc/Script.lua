local function iabaza(msg,MsgText)

if msg.forward_info_ then return false end


if msg.Director 
and (redis:get(abaza..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(abaza..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(abaza..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(abaza..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)) and MsgText[1] ~= "الغاء" then 
return false end 
...
if not redis:get(abaza..'group:add'..msg.chat_id_) then return sendMsg(msg.chat_id_,msg.id_,'✦¹  المجموعه بالتأكيد تم تعطيلها \n \n') end  
...
if redis:get(abaza..'lock_id'..msg.chat_id_) then

GetUserID(msg.sender_user_id_,function(arg,data)

local msgs = redis:get(abaza..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
local edited = (redis:get(abaza..':edited:'..arg.chat_id_..':'..arg.sender_user_id_) or 0)
...
..'• 𝙎𝙏𝘼𝙏𝙎 ➤'..arg.TheRank..' ⊰•\n'
..'• 𝗠𝗦𝗚  ➤ {'..arg.msgs..'} ⊰•\n'
local Kleshaidinfo = redis:get(abaza..":infoiduser_public:"..arg.chat_id_) or redis:get(abaza..":infoiduser")  

if Kleshaidinfo then 
local points = redis:get(abaza..':User_Points:'..arg.chat_id_..arg.sender_user_id_) or 0
...
KleshaID = KleshaID:gsub("#bot",redis:get(abaza..':NameBot:'))
KleshaID = KleshaID:gsub("{المطور}",SUDO_USER)
end
if redis:get(abaza.."idphoto"..msg.chat_id_) then
...
local numvv = redis:get(abaza..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
...
redis:setex(abaza..":Witing_NewRtba:"..msg.chat_id_..msg.sender_user_id_,1000,true)
redis:del(abaza..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SuperCreator  then return "✦¹  هذا الامر يخص {المنشئ الاساسي,المطور} فقط  \n" end
redis:setex(abaza..":Witing_DelNewRtba:"..msg.chat_id_..msg.sender_user_id_,1000,true)
return "- ارسل الرتبه المراد حذفها :\n\n• مطور اساسي \n• مطور \n• منشئ اساسي \n• منشئ \n• مدير \n• ادمن \n• مميز \n"
end
if MsgText[1] == "مسح قائمه الرتب" then
if not msg.SudoUser then return "✦¹  هذا الامر يخص {المطور} فقط  \n" end
redis:del(abaza..":RtbaNew1:"..msg.chat_id_)
redis:del(abaza..":RtbaNew2:"..msg.chat_id_)
redis:del(abaza..":RtbaNew3:"..msg.chat_id_)
redis:del(abaza..":RtbaNew4:"..msg.chat_id_)
redis:del(abaza..":RtbaNew5:"..msg.chat_id_)
redis:del(abaza..":RtbaNew6:"..msg.chat_id_)
redis:del(abaza..":RtbaNew7:"..msg.chat_id_)
...
local Rtba1 = redis:get(abaza..":RtbaNew1:"..msg.chat_id_) or " لايوجد "
local Rtba2 = redis:get(abaza..":RtbaNew2:"..msg.chat_id_) or " لايوجد "
local Rtba3 = redis:get(abaza..":RtbaNew3:"..msg.chat_id_) or " لايوجد "
local Rtba4 = redis:get(abaza..":RtbaNew4:"..msg.chat_id_) or " لايوجد "
local Rtba5 = redis:get(abaza..":RtbaNew5:"..msg.chat_id_) or " لايوجد "
local Rtba6 = redis:get(abaza..":RtbaNew6:"..msg.chat_id_) or " لايوجد "
local Rtba7 = redis:get(abaza..":RtbaNew7:"..msg.chat_id_) or " لايوجد "
...
message = ""
local monsha = redis:smembers(abaza..':MONSHA_Group:'..msg.chat_id_)
if #monsha == 0 then 
message = message .." لا يوجد مالك !\n"
else
for k,v in pairs(monsha) do
local info = redis:hgetall(abaza..'username:'..v)
...
local GroupName = (redis:get(abaza..'group:name'..arg.ChatID) or '')
redis:set(abaza..'LinkGroup'..arg.ChatID,(data.invite_Link_ or ""))
...
if not msg.Director and redis:get(abaza..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(abaza..":MsgIDPin:"..arg.ChatID,arg.reply_id)
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
if not msg.Director and redis:get(abaza..'lock_pin'..msg.chat_id_) then return "لا يمكنك الغاء التثبيت الامر مقفول من قبل الاداره" end
...
elseif redis:sismember(abaza..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"✦¹  لا يمكنك تقييد المطور\n") 
elseif redis:sismember(abaza..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"✦¹  لا يمكنك تقييد المنشئ\n") 
elseif redis:sismember(abaza..':MONSHA_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"✦¹  لا يمكنك تقييد المنشئ الاساسي\n") 
elseif redis:sismember(abaza..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"✦¹  لا يمكنك تقييد المدير\n") 
elseif redis:sismember(abaza..'admins:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"✦¹  لا يمكنك تقييد الادمن\n") 
elseif  redis:sismember(abaza..'whitelist:'..arg.ChatID,UserID) then 
...
redis:set(abaza..":TqeedUser:"..arg.ChatID..arg.UserID,true)
...
elseif redis:sismember(abaza..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"✦¹  لا يمكنك تقييد المنشئ\n") 
elseif redis:sismember(abaza..':MONSHA_Group:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"✦¹  لا يمكنك نقييد المنشئ الاساسي\n") 
elseif redis:sismember(abaza..'owners:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"✦¹  لا يمكنك تقييد المدير\n") 
elseif redis:sismember(abaza..'admins:'..msg.chat_id_,UserID) then 
...
redis:del(abaza..":TqeedUser:"..arg.ChatID..UserID)
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
...
redis:del(abaza..":TqeedUser:"..arg.ChatID..arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم فك تقييده  من المجموعه") 
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(abaza..'basel:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه قرد فالمجموعه") 
else
redis:hset(abaza..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(abaza..'basel:'..arg.ChatID,arg.UserID)
...
if redis:sismember(abaza..'basel:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه قرد في لمجموعه") 
end
redis:hset(abaza..'username:'..UserID,'username',UserName)
redis:sadd(abaza..'basel:'..arg.ChatID,UserID)
...
NameUser = Hyper_Link_Name(data)
if not redis:sismember(abaza..'basel:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله من قائمة القدره") 
else
redis:srem(abaza..'basel:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(abaza..'basel:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله من قائمه القرده")
else
redis:srem(abaza..'basel:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم تنزيله من قائمه القرده") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
local kerd = redis:scard(abaza..'basel:'..msg.chat_id_)
if kerd ==0 then 
return " لا يوجد قرده في المجموعه " 
end
redis:del(abaza..'basel:'..msg.chat_id_)
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(abaza..'basel1:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه قلبك") 
else
redis:hset(abaza..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(abaza..'basel1:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(abaza..'basel1:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه قلبك") 
end
redis:hset(abaza..'username:'..UserID,'username',UserName)
redis:sadd(abaza..'basel1:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم رفعه قلبك") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(abaza..'basel1:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله من قلبك") 
else
redis:srem(abaza..'basel1:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم تنزيله من قلبك") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(abaza..'basel1:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله من قلبك")
else
redis:srem(abaza..'basel1:'..arg.ChatID,UserID)
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
local kerd = redis:scard(abaza..'basel1:'..msg.chat_id_)
if kerd ==0 then 
return " لا يوجد قلوب في المجموعه " 
end
redis:del(abaza..'basel1:'..msg.chat_id_)
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(abaza..'basel2:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه وتكه") 
else
redis:hset(abaza..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(abaza..'basel2:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(abaza..'basel2:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه وتكه") 
end
redis:hset(abaza..'username:'..UserID,'username',UserName)
redis:sadd(abaza..'basel2:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم رفعه وتكه") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(abaza..'basel2:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله من قائمه الوتك") 
else
redis:srem(abaza..'basel2:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(abaza..'basel2:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله من قائمه الوتك")
else
redis:srem(abaza..'basel2:'..arg.ChatID,UserID)
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
local kerd = redis:scard(abaza..'basel2:'..msg.chat_id_)
if kerd ==0 then 
return " لا يوجد وتك في المجموعه كلهم غفر " 
end
redis:del(abaza..'basel2:'..msg.chat_id_)
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(abaza..'basel3:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه زوجتك") 
else
redis:hset(abaza..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(abaza..'basel3:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(abaza..'basel3:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعها زوجتك") 
end
redis:hset(abaza..'username:'..UserID,'username',UserName)
redis:sadd(abaza..'basel3:'..arg.ChatID,UserID)
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(abaza..'basel3:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيل زوجتك") 
else
redis:srem(abaza..'basel3:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(abaza..'basel3:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيلها من قائمه زوجاتك")
else
redis:srem(abaza..'basel3:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم تنزيلها من قائمه زوجاتك") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
local kerd = redis:scard(abaza..'basel3:'..msg.chat_id_)
if kerd ==0 then 
return " لا يوجد لك زوجات فالمجموعه  " 
end
redis:del(abaza..'basel3:'..msg.chat_id_)
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(abaza..'basel4:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه زوجك") 
else
redis:hset(abaza..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(abaza..'basel4:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم رفعه زوجك") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
UserName = arg.UserName
if redis:sismember(abaza..'basel4:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه  زوجك") 
end
redis:hset(abaza..'username:'..UserID,'username',UserName)
redis:sadd(abaza..'basel4:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم رفعه زوجك") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(abaza..'basel4:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله من قائمه ازواجك") 
else
redis:srem(abaza..'basel4:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(abaza..'basel4:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله من قائمه ازواجك")
else
redis:srem(abaza..'basel4:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم تنزيله من قائمه ازواجك") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
local kerd = redis:scard(abaza..'basel4:'..msg.chat_id_)
if kerd ==0 then 
return " لا يوجد لك ازواج في المجموعه يا عانسه" 
end
redis:del(abaza..'basel4:'..msg.chat_id_)
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(abaza..'whitelist:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه مميز  في المجموعه") 
else
redis:hset(abaza..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(abaza..'whitelist:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(abaza..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه مميز  في المجموعه") 
end
redis:hset(abaza..'username:'..UserID,'username',UserName)
redis:sadd(abaza..'whitelist:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم رفعه مميز  في المجموعه") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(abaza..'whitelist:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله مميز  في المجموعه") 
else
redis:srem(abaza..'whitelist:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(abaza..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله مميز  في المجموعه")
else
redis:srem(abaza..'whitelist:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم تنزيله مميز  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if redis:sismember(abaza..'owners:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه مدير  في المجموعه")
else
redis:hset(abaza..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(abaza..'owners:'..arg.ChatID,UserID)
...
UserName = arg.UserName
if redis:sismember(abaza..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه مدير  في المجموعه")
else
redis:hset(abaza..'username:'..UserID, 'username',UserName)
redis:sadd(abaza..'owners:'..arg.ChatID,UserID)
...
if not redis:sismember(abaza..'owners:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله مدير  في المجموعه") 
else
redis:srem(abaza..'owners:'..arg.ChatID,arg.UserID)
...
if not redis:sismember(abaza..'owners:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله مدير  في المجموعه")  
else
redis:srem(abaza..'owners:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم تنزيله مدير  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if redis:sismember(abaza..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه منشئ  في المجموعه") 
else
redis:hset(abaza..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(abaza..':MONSHA_BOT:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(abaza..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه منشئ  في المجموعه") 
else
redis:hset(abaza..'username:'..UserID,'username',UserName)
redis:sadd(abaza..':MONSHA_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم رفعه منشئ  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(abaza..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله منشئ  في المجموعه") 
else
redis:srem(abaza..':MONSHA_BOT:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(abaza..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله منشئ  في المجموعه") 
else
redis:srem(abaza..':MONSHA_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم تنزيله منشئ  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
ReUsername = ResolveUserName(data)
NameUser   = Hyper_Link_Name(data)
if redis:sismember(abaza..'admins:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه ادمن  في المجموعه") 
else
redis:hset(abaza..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(abaza..'admins:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(abaza..'admins:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه ادمن  في المجموعه") 
else
redis:hset(abaza..'username:'..UserID,'username',UserName)
redis:sadd(abaza..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم رفعه ادمن  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(abaza..'admins:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله ادمن  في المجموعه") 
else
redis:srem(abaza..'admins:'..arg.ChatID,arg.UserID)
...
local UserID = data.id_
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(abaza..'admins:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله ادمن  في المجموعه") 
else
redis:srem(abaza..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم تنزيله ادمن  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
local maseegs = redis:get(abaza..'msgs:'..arg.UserID..':'..arg.ChatID) or 1
local edited = redis:get(abaza..':edited:'..arg.ChatID..':'..arg.UserID) or 0
local content = redis:get(abaza..':adduser:'..arg.ChatID..':'..arg.UserID) or 0
...
NameUser = Hyper_Link_Name(data)
local maseegs = redis:get(abaza..'msgs:'..UserID..':'..arg.ChatID) or 1
local edited = redis:get(abaza..':edited:'..arg.ChatID..':'..UserID) or 0
local content = redis:get(abaza..':adduser:'..arg.ChatID..':'..UserID) or 0
...
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"✦¹  لا يمكنك تنفيذ الامر بالرد ع رسالة البوت \n") end
GetUserID(UserID,function(arg,data)
if msg.SudoBase then redis:srem(abaza..'gban_users',arg.UserID)  end 
Restrict(arg.ChatID,arg.UserID,2)
redis:srem(abaza..'banned:'..arg.ChatID,arg.UserID)
StatusLeft(arg.ChatID,arg.UserID)
redis:srem(abaza..'is_silent_users:'..arg.ChatID,arg.UserID)
NameUser = Hyper_Link_Name(data)
...
local UserID = data.id_
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"✦¹  لا يمكنك تنفيذ الامر بالرد ع رسالة البوت \n") end
if msg.SudoBase then redis:srem(abaza..'gban_users',UserID)  end 
Restrict(arg.ChatID,UserID,2)
redis:srem(abaza..'banned:'..arg.ChatID,UserID)
StatusLeft(arg.ChatID,UserID)
redis:srem(abaza..'is_silent_users:'..arg.ChatID,UserID)
NameUser = Hyper_Link_Name(data)
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم رفع القيود ان وجد  \n") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
if msg.SudoBase then redis:srem(abaza..'gban_users',MsgText[2])  end 
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
if not msg.Creator and not redis:get(abaza.."lock_KickBan"..msg.chat_id_) then return "✦¹  الامر معطل من قبل اداره المجموعة  \n" end
...
NameUser = Hyper_Link_Name(data)
USERNAME = ResolveUserName(data)
if redis:sismember(abaza..'banned:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم بالتأكيد حظره  من المجموعه") 
end

redis:hset(abaza..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(abaza..'banned:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم حظره  من المجموعه") 
end,{ChatID=arg.ChatID,UserID=arg.UserID,MsgID=arg.MsgID})
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
...
if redis:sismember(abaza..'banned:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم بالتأكيد حظره  من المجموعه") 
end
kick_user(UserID,arg.ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
redis:hset(abaza..'username:'..arg.UserID, 'username',arg.UserName)
redis:sadd(abaza..'banned:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم حظره  من المجموعه") 
...
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"✦¹  عذرا هذا معرف قناة وليس حساب \n") end
redis:hset(abaza..'username:'..arg.UserID,'username',USERNAME)
redis:setex(abaza..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,500,NameUser)
redis:setex(abaza..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,500,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"✦¹  عذرا هذا معرف قناة وليس حساب \n") end
redis:hset(abaza..'username:'..UserID,'username',arg.USERNAME)
redis:setex(abaza..":uploadingsomeon:"..arg.ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(abaza..":uploadingsomeon2:"..arg.ChatID..msg.sender_user_id_,500,UserID)
sendMsg(arg.ChatID,arg.MsgID,"  ⇠ حسننا الان ارسل صلاحيات المشرف :\n\n¦1- صلاحيه تغيير المعلومات\n¦2- صلاحيه حذف الرسائل\n¦3- صلاحيه دعوه مستخدمين\n¦4- صلاحيه حظر وتقيد المستخدمين \n¦5- صلاحيه تثبيت الرسائل \n¦6- صلاحيه رفع مشرفين اخرين\n\n¦[*]- لرفع كل الصلاحيات ما عدا رفع المشرفين \n¦[**] - لرفع كل الصلاحيات مع رفع المشرفين \n\n✦¹  يمكنك اختيار الارقام معا وتعيين الكنيه للمشرف في ان واحد مثلا : \n\n¦ 136 باسل\n") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,USERNAME=MsgText[2]})
...
GetChatMember(arg.ChatID,arg.UserID,function(arg,data)
if (data.status_.ID == "ChatMemberStatusKicked" or redis:sismember(abaza..'banned:'..arg.ChatID,arg.UserID)) then
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(abaza..'banned:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم بالتأكيد الغاء حظره  من المجموعه") 
else
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم الغاء حظره  من المجموعه") 
end
...
USERNAME = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(abaza..'is_silent_users:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم بالتأكيد كتمه  من المجموعه") 
else
redis:hset(abaza..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(abaza..'is_silent_users:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم كتمه  من المجموعه") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
if redis:sismember(abaza..'is_silent_users:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم بالتأكيد كتمه  من المجموعه") 
else
redis:hset(abaza..'username:'..UserID,'username',UserName)
redis:sadd(abaza..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم كتمه  من المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then 
...
if not redis:sismember(abaza..'is_silent_users:'..arg.ChatID,arg.UserID) then 
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(abaza..'is_silent_users:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم بالتأكيد الغاء كتمه  من المجموعه") 
else
redis:srem(abaza..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم الغاء كتمه  من المجموعه") 
...
redis:setex(abaza..'WiCmdLink'..msg.chat_id_..msg.sender_user_id_,500,true)
return '✦¹  حسننا عزيزي  \n✦¹  الان ارسل  رابط مجموعتك '
end

if MsgText[1] == "انشاء رابط" then
if not msg.Creator then return "✦¹  هذا الامر يخص {المطور,المنشئ الاساسي ,المنشئ} فقط  \n" end
if not redis:get(abaza..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(abaza..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(abaza..'ExCmdLink'..msg.chat_id_,120,true)
...
if not redis:get(abaza.."lock_linkk"..msg.chat_id_) then return "✦¹  الامر معطل من قبل الادارة \n^"  end
if not redis:get(abaza..'linkGroup'..msg.chat_id_) then return "✦¹   لا يوجد رابط\n✦¹ لانشاء رابط ارسل { انشاء رابط } \n" end
local GroupName = redis:get(abaza..'group:name'..msg.chat_id_)
local GroupLink = redis:get(abaza..'linkGroup'..msg.chat_id_)
return "✦¹  رابـط الـمـجـمـوعه :\n\n["..GroupLink.."]\n"
end

if MsgText[1] == "ضع القوانين" then
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
redis:setex(abaza..'rulse:witting'..msg.chat_id_..msg.sender_user_id_,300,true)
return '✦¹  حسننا عزيزي  \n✦¹  الان ارسل القوانين  للمجموعه '
end

if MsgText[1] == "القوانين" then
if not redis:get(abaza..'rulse:msg'..msg.chat_id_) then 
...
return "*ঌالقوانين :*\n"..redis:get(abaza..'rulse:msg'..msg.chat_id_) 
end 
end
...
redis:set(abaza..'num_msg_max'..msg.chat_id_,MsgText[2]) 
...
local NumLoop = tonumber(MsgText[2])
redis:set(abaza..':Timer_Cleaner:'..msg.chat_id_,NumLoop) 
...
local Admins = redis:scard(abaza..':MONSHA_Group:'..msg.chat_id_)
if Admins == 0 then  
return "✦¹  اوه ☢ هنالك خطأ \n عذرا لا يوجد منشئيين اساسييين ليتم مسحهم " 
end
redis:del(abaza..':MONSHA_Group:'..msg.chat_id_)
...
if not msg.Creator then return "✦¹  هذا الامر يخص {المطور,المنشئ} فقط  \n" end
local mmezz = redis:smembers(abaza..":IdsMsgsCleaner:"..msg.chat_id_)
...
redis:del(abaza..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
...
local Admins = redis:scard(abaza..'admins:'..msg.chat_id_)
if Admins == 0 then  
return " عذرا لا يوجد ادمنيه ليتم مسحهم " 
end
redis:del(abaza..'admins:'..msg.chat_id_)
return "ঌ بواسطه ⇠ "..msg.TheRankCmd.."   \n تم مسح {"..Admins.."} من الادمنيه في البوت \n"
end
...
if not msg.Director then return "✦¹  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(abaza..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "✦¹  عذرا لا توجد كلمات ممنوعه ليتم حذفها " 
end
redis:del(abaza..':Filter_Word:'..msg.chat_id_)
...
redis:del(abaza..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "✦¹  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(abaza..'welcome:msg'..msg.chat_id_) then 
return " لاحظ \n عذرا لا يوجد ترحيب ليتم مسحه " 
end
redis:del(abaza..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(abaza..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return " عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(abaza..':MONSHA_BOT:'..msg.chat_id_)
...
if not msg.Creator then return "✦¹  هذا الامر يخص {المطور,المنشئ} فقط  \n" end
local NumMDER = redis:scard(abaza..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
return " عذرا لا يوجد مدراء ليتم مسحهم \n!" 
end
redis:del(abaza..'owners:'..msg.chat_id_)
...
local list = redis:smembers(abaza..'banned:'..msg.chat_id_)
if #list == 0 then return "* لا يوجد مستخدمين محظورين  *" end
message = ' قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(abaza..'banned:'..msg.chat_id_)
return "ঌ بواسطه ⇠ "..msg.TheRankCmd.."   \n  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[1] == 'مسح المكتومين' then
if not msg.Director then return "✦¹  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(abaza..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "✦¹  لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(abaza..'is_silent_users:'..msg.chat_id_)
return "ঌ بواسطه ⇠ "..msg.TheRankCmd.."   \n  تم مسح {* "..MKTOMEN.." *} من المكتومين  \n"
end

if MsgText[1] == 'مسح المميزين' then
if not msg.Director then return "✦¹  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MMEZEN = redis:scard(abaza..'whitelist:'..msg.chat_id_)
if MMEZEN ==0 then 
return " لا يوجد مستخدمين مميزين في المجموعه " 
end
redis:del(abaza..'whitelist:'..msg.chat_id_)
return "ঌ بواسطه ⇠ "..msg.TheRankCmd.."   \n  تم مسح {* "..MMEZEN.." *} من المميزين  \n"
end

if MsgText[1] == 'مسح الرابط' then
if not msg.Director then return "✦¹  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(abaza..'linkGroup'..msg.chat_id_) then 
return " لا يوجد رابط مضاف اصلا " 
end
redis:del(abaza..'linkGroup'..msg.chat_id_)
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
redis:setex(abaza..'name:witting'..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(abaza..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
redis:setex(abaza..'about:witting'..msg.chat_id_..msg.sender_user_id_,300,true) 
return "✦¹  حسننا عزيزي  \n✦¹  الان ارسل الوصف  للمجموعه\n" 
end

if MsgText[1] == "تاك للكل" then
if not msg.Admin then return " هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not redis:get(abaza.."lock_takkl"..msg.chat_id_) then  return "الامر معطل من قبل الادراة يبشه." end 
redis:setex(abaza..'chat:tagall'..msg.chat_id_,300,true)
...
if redis:sismember(abaza..':Filter_Word:'..arg.ChatID,Type_id) then 
return sendMsg(arg.ChatID,arg.MsgID," هي بالتأكيد في قائمه المنع️")
else
redis:sadd(abaza..':Filter_Word:'..arg.ChatID,Type_id) 
...
if redis:sismember(abaza..':Filter_Word:'..arg.ChatID,Type_id) then 
redis:srem(abaza..':Filter_Word:'..arg.ChatID,Type_id) 
...
kick_user(v.user_id_,arg.ChatID,function(arg,data)  
redis:srem(abaza..':MONSHA_BOT:'..arg.ChatID,v.user_id_)
redis:srem(abaza..'whitelist:'..arg.ChatID,v.user_id_)
redis:srem(abaza..'owners:'..arg.ChatID,v.user_id_)
redis:srem(abaza..'admins:'..arg.ChatID,v.user_id_)
end)
end
NumMem = NumMem + 1
...
redis:setex(abaza..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(abaza..'CheckExpire::'..msg.chat_id_) then 
redis:set(abaza..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️¦ تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️¦ تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️¦ في مجموعه  ⇠ ⇠  '..redis:get(abaza..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "✦¹  هذا الامر يخص {المطور} فقط  \n" end
if MsgText[2] == '1' then
redis:setex(abaza..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(abaza..'CheckExpire::'..msg.chat_id_) then 
redis:set(abaza..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️¦ تم تفعيل الاشتراك   👍🏿\n  الاشتراك ⇠ `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️¦ تم تفعيل الاشتراك  👍🏿\n  الاشتراك ⇠ `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(abaza..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(abaza..'CheckExpire::'..msg.chat_id_) then 
redis:set(abaza..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(abaza..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(abaza..'CheckExpire::'..msg.chat_id_) then 
redis:set(abaza..'CheckExpire::'..msg.chat_id_,true) end
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
local check_time = redis:ttl(abaza..'ExpireDate:'..msg.chat_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(abaza..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(abaza..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(abaza..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(abaza..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(abaza..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(abaza..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(abaza..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(abaza..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(abaza..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
return '✦¹   عدد جهاتك يبشه‏‏ ⇠ 【'..(redis:get(abaza..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..'】 . \n'
end
...
SUDO_USER = redis:hgetall(abaza..'username:'..SUDO_ID).username
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
redis:set(abaza..'welcom:witting'..msg.chat_id_..msg.sender_user_id_,true) 
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
if redis:get(abaza..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(abaza..'welcome:msg'..msg.chat_id_))
else 
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(abaza..':MONSHA_Group:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه منشئ اساسي  في المجموعه") 
else
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم رفعه منشئ اساسي  في المجموعه") 
redis:hset(abaza..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(abaza..':MONSHA_Group:'..arg.ChatID,arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if redis:sismember(abaza..':MONSHA_Group:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه منشئ اساسي  في المجموعه") 
else
redis:hset(abaza..'username:'..UserID,'username',arg.UserName)
redis:sadd(abaza..':MONSHA_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم رفعه منشئ اساسي  في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not redis:sismember(abaza..':MONSHA_Group:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه") 
else
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم تنزيله منشئ اساسي  في المجموعه") 
redis:srem(abaza..':MONSHA_Group:'..arg.ChatID,arg.UserID)
end  
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
UserName = Flter_Markdown(arg.UserName)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(abaza..':MONSHA_Group:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه") 
else
redis:srem(abaza..':MONSHA_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم تنزيله منشئ اساسي  في المجموعه")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
redis:del(abaza..":awamer_Klesha_m1:")
redis:del(abaza..":awamer_Klesha_m2:")
redis:del(abaza..":awamer_Klesha_m3:")
redis:del(abaza..":awamer_Klesha_mtwr:")
redis:del(abaza..":awamer_Klesha_mrd:")
redis:del(abaza..":awamer_Klesha_mf:")
redis:del(abaza..":awamer_Klesha_m:")
...
redis:del(abaza..":infoiduser_public:"..msg.chat_id_)
...
if not msg.Creator then return "✦¹  هذا الامر يخص {منشئ اساسي,المنشئ,المطور} فقط  \n" end
redis:setex(abaza..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,1000,true)
return 'ঌ حسننا , الان ارسل كليشه الايدي الجديده \n علما ان الاختصارات كالاتي : \n \n#name : لوضع اسم المستخدم\n#id : لوضع ايدي المستخدم\n#username : لوضع معرف المستخدم \n#stast : لوضع نوع رتبه المستخدم \n#game : لوضع تفاعل المستخدم \n#msgs : لاضهار عدد الرسائل \n#auto : لاضهار عدد النقاط \n#edit : لاضهار عدد السحكات \n#bot : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n قناه تعليمات ونشر كلايش الايدي \n قناه الكلايش : [@ABAZA_id] \n➼' 
end
...
elseif redis:sismember(abaza..'admins:'..msg.chat_id_,UserID) then 
rinkuser = 6
elseif redis:sismember(abaza..'whitelist:'..msg.chat_id_,UserID) then 
rinkuser = 7
else
rinkuser = 8
end
local DonisDown = "\n تم تنزيله من الرتب الاتيه : \n\n "
if redis:sismember(abaza..':SUDO_BOT:',UserID) then 
DonisDown = DonisDown.."✦¹  تم تنزيله من المطور ️\n"
end 
if redis:sismember(abaza..':MONSHA_Group:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."✦¹  تم تنزيله من المنشئ الاساسي ️\n"
end 
if redis:sismember(abaza..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."✦¹  تم تنزيله من المنشئ ️\n"
end 
if redis:sismember(abaza..'owners:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."✦¹  تم تنزيله من المدير ️\n"
end 
if redis:sismember(abaza..'admins:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."✦¹  تم تنزيله من الادمن ️\n"
end 
if redis:sismember(abaza..'whitelist:'..msg.chat_id_,UserID) then
...
redis:srem(abaza..':SUDO_BOT:',UserID)
redis:srem(abaza..':MONSHA_Group:'..msg.chat_id_,UserID)
redis:srem(abaza..':MONSHA_BOT:'..msg.chat_id_,UserID)
redis:srem(abaza..'owners:'..msg.chat_id_,UserID)
redis:srem(abaza..'admins:'..msg.chat_id_,UserID)
redis:srem(abaza..'whitelist:'..msg.chat_id_,UserID)
...
if not msg.Director then return "✦¹  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local list = redis:hgetall(abaza..":AwamerBotArray2:"..msg.chat_id_)
local list2 = redis:hgetall(abaza..":AwamerBotArray:"..msg.chat_id_)
...
if not msg.Director then return "✦¹  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Awammer 	= redis:del(abaza..":AwamerBot:"..msg.chat_id_)
redis:del(abaza..":AwamerBotArray:"..msg.chat_id_)
redis:del(abaza..":AwamerBotArray2:"..msg.chat_id_)
if Awammer ~= 0 then
...
for k, abaza in pairs(Xabaza) do if MsgText[2]:match(abaza) then  checkAmr = true end end      
if checkAmr then
redis:setex(abaza..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,300,MsgText[2])
return "✦¹  حسننا عزيزي , لتغير امر {* "..MsgText[2].." *}  ارسل الامر الجديد الان \n..."
else
return "✦¹  عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n"
end
else
redis:setex(abaza..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Director then return "✦¹  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if MsgText[2] then
local checkk = redis:hdel(abaza..":AwamerBotArray2:"..msg.chat_id_,MsgText[2])
local AmrOld = redis:hgetall(abaza..":AwamerBotArray:"..msg.chat_id_)
amrnew = ""
amrold = ""
...
redis:hdel(abaza..":AwamerBotArray:"..msg.chat_id_,Amor)
...
redis:setex(abaza..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(abaza..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(abaza..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,1000,true)
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(abaza..':SUDO_BOT:',arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد رفعه مطور  في البوت") 
else
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم رفعه مطور  في البوت") 
redis:hset(abaza..'username:'..arg.UserID,'username',RUSERNAME)
redis:sadd(abaza..':SUDO_BOT:',arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
redis:hset(abaza..'username:'..UserID,'username',ReUsername)
redis:sadd(abaza..':SUDO_BOT:',UserID)
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم رفعه مطور  في البوت") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(abaza..':SUDO_BOT:',arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله مطور  في البوت") 
else
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم تنزيله مطور  في البوت") 
redis:srem(abaza..':SUDO_BOT:',arg.UserID)
end  
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if not redis:sismember(abaza..':SUDO_BOT:',UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم بالتأكيد تنزيله مطور  في البوت") 
else
redis:srem(abaza..':SUDO_BOT:',UserID)
sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \nঌ تم تنزيله مطور  في البوت") 
...
local groups = redis:smembers(abaza..'group:ids')
...
local pv = redis:smembers(abaza..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(abaza..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(abaza..':WELCOME_BOT')
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[✦¹  مـرحبا أنا بوت آسـمـي ]]..redis:get(abaza..':NameBot:')..[[ 🎖
...
redis:setex(abaza..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '✦¹  حسننا عزيزي ✦¹ \nঌ الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(abaza..':addnumberusers',MsgText[2]) 
return '💱 تم وضـع شـرط آلتفعيل آلبوت آذآ كآنت آلمـجمـوعهہ‏‏ آكثر مـن *【'..MsgText[2]..'】* عضـو  ✦¹ \n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'✦¹  شـرط آلتفعيل آلبوت آذآ كآنت آلمـجمـوعهہ‏‏ آكثر مـن *【'..redis:get(abaza..':addnumberusers')..'】* عضـو  ✦¹ \n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🔝" then 
if not msg.SudoUser then return "✦¹  هذا الامر يخص {المطور} فقط  \n" end
return 'ঌ عدد المجموعات المفعلة ⇠ `'..redis:scard(abaza..'group:ids')..'`  ➼' 
end
...
if not msg.SudoUser then return "✦¹  هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(abaza.."lockidedit") then return "✦¹  الامر معطل من قبل المطور الاساسي  \n" end
redis:del(abaza..":infoiduser")
...
if not msg.SudoUser then return "✦¹  هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(abaza.."lockidedit") then return "✦¹  تعيين الايدي معطل من قبل المطور الاساسي  \n" end
redis:setex(abaza..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,1000,true)
return 'ঌ حسننا , الان ارسل كليشه الايدي الجديده \n علما ان الاختصارات كالاتي : \n \n#name : لوضع اسم المستخدم\n#id : لوضع ايدي المستخدم\n#username : لوضع معرف المستخدم \n#stast : لوضع نوع رتبه المستخدم \n#game : لوضع تفاعل المستخدم \n#msgs : لاضهار عدد الرسائل \n#auto : لاضهار عدد النقاط \n#edit : لاضهار عدد السحكات \n#bot : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n قناه تعليمات ونشر كلايش الايدي \n قناه الكلايش : [@ABAZA_id] \n➼' 
end
...
redis:setex(abaza..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(abaza..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(abaza..'fwd:groups'..msg.sender_user_id_,300, true) 
...
redis:hset(abaza..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(abaza..'gban_users',arg.UserID)
...
if redis:sismember(abaza..'gban_users',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم بالتأكيد حظره عام  من المجموعات \n") 
else
redis:hset(abaza..'username:'..UserID,'username',UserName)
redis:sadd(abaza..'gban_users',UserID)
...
if GeneralBanned(arg.UserID) then 
redis:srem(abaza..'gban_users',arg.UserID)
...
if not redis:sismember(abaza..'gban_users',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم بالتأكيد الغاء حظره العام  من المجموعات \n") 
else
redis:srem(abaza..'gban_users',UserID)
return sendMsg(arg.ChatID,arg.MsgID,"ঌ المستخدم  ⇠「 "..NameUser.." 」 \n✦¹  تم الغاء حظره العام  من المجموعات \n") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
redis:del(abaza..'welcom:witting'..msg.chat_id_..msg.sender_user_id_,
abaza..'rulse:witting'..msg.chat_id_..msg.sender_user_id_,
abaza..'name:witting'..msg.chat_id_..msg.sender_user_id_,
abaza..'about:witting'..msg.chat_id_..msg.sender_user_id_,
abaza..'fwd:all'..msg.sender_user_id_,
abaza..'fwd:pv'..msg.sender_user_id_,
abaza..'fwd:groups'..msg.sender_user_id_,
abaza..'namebot:witting'..msg.sender_user_id_,
abaza..'addrd_all:'..msg.sender_user_id_,
abaza..'delrd:'..msg.sender_user_id_,
abaza..'addrd:'..msg.sender_user_id_,
abaza..'delrdall:'..msg.sender_user_id_,
abaza..'text_sudo:witting'..msg.sender_user_id_,
abaza..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
abaza..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,
abaza..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,
abaza..'addrd:'..msg.chat_id_..msg.sender_user_id_,
abaza..':KStart:'..msg.chat_id_..msg.sender_user_id_,
abaza.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_,
abaza..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,
abaza..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,
abaza..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,
abaza..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,
abaza..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,
abaza..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,
abaza..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
abaza..":ForceSub:"..msg.sender_user_id_,
abaza..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,
abaza..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_,
abaza..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_,
abaza..'replay1Random'..msg.chat_id_..msg.sender_user_id_,
abaza..'addrdRandom1:'..msg.sender_user_id_,
abaza..'addrdRandom:'..msg.sender_user_id_,
abaza..'replay1Random'..msg.sender_user_id_)
...
redis:set(abaza..":VERSION",GetVerison)
return false
else
...
local inline = {{{text="Source Channel : ABAZA",url="T.ME/jjxxh"}}}
send_key(msg.sender_user_id_,'  [Source : ABAZA ](T.ME/jjxxh)',nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
return 'الاحصائيات :  \n\n عدد المجموعات المفعله : '..redis:scard(abaza..'group:ids')..'\n✦¹  عدد المشتركين في البوت : '..redis:scard(abaza..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(abaza..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(abaza..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return"✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(abaza..':KStart:'..msg.chat_id_..msg.sender_user_id_,900,true)
...
if not msg.SudoBase then return"✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:del(abaza..':Text_Start')
return "✦¹  تم مسح كليشه الستارت "
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "✦¹  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(abaza..'replay:'..msg.chat_id_)
local photo 	= redis:exists(abaza..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(abaza..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(abaza..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(abaza..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(abaza..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(abaza..'replay_video:group:'..msg.chat_id_)
local file 	= redis:exists(abaza..'replay_files:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video or file then
redis:del(abaza..'replay:'..msg.chat_id_,abaza..'replay_photo:group:'..msg.chat_id_,abaza..'replay_voice:group:'..msg.chat_id_,
abaza..'replay_animation:group:'..msg.chat_id_,abaza..'replay_audio:group:'..msg.chat_id_,abaza..'replay_sticker:group:'..msg.chat_id_,abaza..'replay_video:group:'..msg.chat_id_,abaza..'replay_files:group:'..msg.chat_id_)
...
if not msg.SudoBase then return"✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local names 	= redis:exists(abaza..'replay:all')
local photo 	= redis:exists(abaza..'replay_photo:group:')
local voice 	= redis:exists(abaza..'replay_voice:group:')
local imation 	= redis:exists(abaza..'replay_animation:group:')
local audio 	= redis:exists(abaza..'replay_audio:group:')
local sticker 	= redis:exists(abaza..'replay_sticker:group:')
local video 	= redis:exists(abaza..'replay_video:group:')
local file 	= redis:exists(abaza..'replay_files:group:')
if names or photo or voice or imation or audio or sticker or video or file then
redis:del(abaza..'replay:all',abaza..'replay_photo:group:',abaza..'replay_voice:group:',abaza..'replay_animation:group:',abaza..'replay_audio:group:',abaza..'replay_sticker:group:',abaza..'replay_video:group:',abaza..'replay_files:group:')
...
if not msg.SudoBase then return"✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(abaza..'delrdall:'..msg.sender_user_id_,true) 
return "✦¹  حسننا عزيزي  \n✦¹  الان ارسل الرد لمسحها من  المجموعات "
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "✦¹  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(abaza..'delrd:'..msg.sender_user_id_,true)
...
if not msg.Director then return "✦¹  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(abaza..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(abaza..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(abaza..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(abaza..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(abaza..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(abaza..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(abaza..'replay_video:group:'..msg.chat_id_)
local files 	= redis:hkeys(abaza..'replay_files:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(abaza..'replay:all')
local photo 	= redis:hkeys(abaza..'replay_photo:group:')
local voice 	= redis:hkeys(abaza..'replay_voice:group:')
local imation 	= redis:hkeys(abaza..'replay_animation:group:')
local audio 	= redis:hkeys(abaza..'replay_audio:group:')
local sticker 	= redis:hkeys(abaza..'replay_sticker:group:')
local video 	= redis:hkeys(abaza..'replay_video:group:')
local files 	= redis:hkeys(abaza..'replay_files:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 and #files==0 then 
return '✦¹  لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "✦¹  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(abaza..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_,1400,true) 
redis:del(abaza..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "✦¹  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(abaza..':DelrdRandom:'..msg.chat_id_..msg.sender_user_id_,300,true)
...
local AlRdod = redis:smembers(abaza..':KlmatRRandom:'..msg.chat_id_) 
if #AlRdod == 0 then return "✦¹  الردود العشوائيه محذوفه بالفعل\n" end
for k,v in pairs(AlRdod) do redis:del(abaza..':ReplayRandom:'..msg.chat_id_..":"..v) redis:del(abaza..':caption_replay:Random:'..msg.chat_id_..v) 
end
redis:del(abaza..':KlmatRRandom:'..msg.chat_id_) 
...
local incrr = redis:scard(abaza..':ReplayRandom:'..msg.chat_id_..":"..v) 
...
if not msg.SudoUser then return "✦¹  هذا الامر يخص {المطور} فقط  \n" end
redis:setex(abaza..'addrdRandom1Public:'..msg.chat_id_..msg.sender_user_id_,1400,true) 
redis:del(abaza..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoUser then return "✦¹  هذا الامر يخص {المطور} فقط  \n" end
redis:setex(abaza..':DelrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_,300,true)
return "✦¹  حسننا عزيزي  \n✦¹  الان ارسل الرد العشوائي العام لمسحها "
end

if MsgText[1] == "مسح الردود العشوائيه العامه" then
if not msg.SudoUser then return "✦¹  هذا الامر يخص {المطور} فقط  \n" end
local AlRdod = redis:smembers(abaza..':KlmatRRandom:') 
if #AlRdod == 0 then return "✦¹  الردود العشوائيه محذوفه بالفعل\n" end
for k,v in pairs(AlRdod) do redis:del(abaza..":ReplayRandom:"..v) redis:del(abaza..':caption_replay:Random:'..v)  end
redis:del(abaza..':KlmatRRandom:') 
return "✦¹  أهلا عزيزي "..msg.TheRankCmd.."  \n✦¹  تم مسح جميع الردود العشوائيه\n"
end
...
for k,v in pairs(AlRdod) do
local incrr = redis:scard(abaza..":ReplayRandom:"..v) 
message = message..k..'- ['..v..'] ⇠ •⊱ {*'..incrr..'*} ⊰• رد\n'
end
end
return message.."\n"
...
if not msg.Director then return "✦¹  هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(abaza..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(abaza..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "✦¹  حسننا , الان ارسل كلمه الرد \n-"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(abaza..'namebot:witting'..msg.sender_user_id_,300,true)
...
echo '*------------------------------\n*l •⊱ { مـده تـشغيـل الـسـيـرفـر } ⊰•  \n*⇠⇠ '"$uptime"'*'
	...
	local texs =[[ اهلا بك في اوامر البوتوت 
✦¹  للاستفسار @xb_0b
...
return false
    ...
    if msg.SudoBase and (MsgText[1]=="م1" or MsgText[1]=="م2" or MsgText[1]=="م3" or MsgText[1]=="م المطور" or MsgText[1]=="اوامر الرد" or MsgText[1]=="الاوامر" or MsgText[1]=="اوامر الملفات") and redis:get(abaza..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
    redis:del(abaza..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_)
    redis:setex(abaza..":changawmer:"..msg.chat_id_..msg.sender_user_id_,900,MsgText[1])
    ...
    GetUserID(msg.sender_user_id_,function(arg,data)
    msg = arg.msg
    local textD = redis:get(abaza..":awamer_Klesha_mf:")
    if textD then
...
if not redis:get(abaza.."lock_leftgroup"..msg.chat_id_) then  return "✦¹  امر المغادره معطل من قبل اداره المجموعة  \n" end
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Ok" then
StatusLeft(msg.chat_id_,msg.sender_user_id_)
send_msg(msg.sender_user_id_," اهلا عزيزي , لقد تم طردك من المجموعه بامر منك \nঌ اذا كان هذا بالخطأ او اردت الرجوع للمجموعه \n\nঌفهذا رابط المجموعه \n✦¹ "..Flter_Markdown(redis:get(abaza..'group:name'..msg.chat_id_)).." :\n\n["..redis:get(abaza..'LinkGroup'..msg.chat_id_).."]\n")
...
if not msg.SudoBase then return"✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
if redis:get(abaza..":UserNameChaneel") then
return " اهلا عزيزي المطور \nঌ الاشتراك بالتأكيد مفعل"
else
redis:setex(abaza..":ForceSub:"..msg.sender_user_id_,350,true)
...
if not msg.SudoBase then return"✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(abaza..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(abaza..":UserNameChaneel")
if UserChaneel then
...
local function dabaza(msg)

if msg.type == "pv" then 

if not msg.SudoUser then
local msg_pv = tonumber(redis:get(abaza..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(abaza..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'** تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(abaza..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(abaza..'users',msg.sender_user_id_)
SUDO_USER = redis:hgetall(abaza..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
SUDO_USERR = "✦¹  مـعرف آلمـطـور  : "..SUDO_USER
else
...
text = [[✦¹  مـرحبآ آنآ بوت آسـمـي []]..redis:get(abaza..':NameBot:')..[[] 
✦¹  يمكنني حمايه المجموعات من السبام والتوجيه الخ....
...
GetUserID(msg.sender_user_id_,function(arg,data)
if data.last_name_ then Name = data.first_name_ .." "..data.last_name_ else Name = data.first_name_ end
text = redis:get(abaza..':Text_Start') or text
local edited = (redis:get(abaza..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local points = redis:get(abaza..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
local Emsgs = redis:get(abaza..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
text = text:gsub("#bot",redis:get(abaza..':NameBot:'))
...
local MSG_ID = (redis:get(abaza.."USER_MSG_TWASEL"..data.forward_info_.date_) or 1)
msg = arg.msg
local SendOk = false
...
if not redis:get(abaza..'lock_twasel') then
...
redis:setex(abaza.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
if public then
redis:hset(abaza..':caption_replay:Random:'..msg.klma,input,msg.content_.caption_) 
else
redis:hset(abaza..':caption_replay:Random:'..msg.chat_id_..msg.klma,input,msg.content_.caption_) 
end
end
end

--====================== Reply Random Public =====================================
if redis:get(abaza..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_) and redis:get(abaza..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_) then
klma = redis:get(abaza..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
msg.klma = klma
if msg.text == "تم" then
redis:del(abaza..'addrdRandom1Public:'..msg.chat_id_..msg.sender_user_id_)
redis:del(abaza..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_)
sendMsg(msg.chat_id_,msg.id_,'¦ تم اضافه رد متعدد عشوائي بنجاح \n✦¹ ¦ يمكنك ارسال (['..klma..']) لاضهار الردود العشوائيه .')
redis:del(abaza..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_)
return false
end

local CountRdod = redis:scard(abaza..':ReplayRandom:'..klma) or 1
...
redis:sadd(abaza..':KlmatRRandom:',klma) 
redis:sadd(abaza..':ReplayRandom:'..klma,":Text:"..msg.text) 
...
redis:sadd(abaza..':KlmatRRandom:',klma) 
redis:sadd(abaza..':ReplayRandom:'..klma,":Photo:"..photo_id) 
...
elseif msg.content_.ID == "MessageVoice" then
redis:sadd(abaza..':KlmatRRandom:',klma) 
redis:sadd(abaza..':ReplayRandom:'..klma,":Voice:"..msg.content_.voice_.voice_.persistent_id_) 
...
elseif msg.content_.ID == "MessageAnimation" then
redis:sadd(abaza..':KlmatRRandom:',klma) 
redis:sadd(abaza..':ReplayRandom:'..klma,":Animation:"..msg.content_.animation_.animation_.persistent_id_) 
...
elseif msg.content_.ID == "MessageVideo" then
redis:sadd(abaza..':KlmatRRandom:',klma) 
redis:sadd(abaza..':ReplayRandom:'..klma,":Video:"..msg.content_.video_.video_.persistent_id_) 
...
elseif msg.content_.ID == "MessageAudio" then
redis:sadd(abaza..':KlmatRRandom:',klma) 
redis:sadd(abaza..':ReplayRandom:'..klma,":Audio:"..msg.content_.audio_.audio_.persistent_id_) 
...
redis:sadd(abaza..':KlmatRRandom:',klma) 
redis:sadd(abaza..':ReplayRandom:'..klma,":Document:"..msg.content_.document_.document_.persistent_id_) 
...
elseif msg.content_.ID == "MessageSticker" then
redis:sadd(abaza..':KlmatRRandom:',klma) 
redis:sadd(abaza..':ReplayRandom:'..klma,":Sticker:"..msg.content_.sticker_.sticker_.persistent_id_) 
...
if redis:get(abaza..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_) and redis:get(abaza..'replay1Random'..msg.chat_id_..msg.sender_user_id_) then
klma = redis:get(abaza..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
msg.klma = klma
if msg.text == "تم" then
redis:del(abaza..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_)
redis:del(abaza..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_)
sendMsg(msg.chat_id_,msg.id_,'♻ تم اضافه رد متعدد عشوائي بنجاح \n✦¹ ¦ يمكنك ارسال (['..klma..']) لاظهار الردود العشوائيه .')
redis:del(abaza..'replay1Random'..msg.chat_id_..msg.sender_user_id_)
return false
end

local CountRdod = redis:scard(abaza..':ReplayRandom:'..msg.chat_id_..":"..klma) or 1
local CountRdod2 = 10 - tonumber(CountRdod)
local CountRdod = 9 - tonumber(CountRdod)
if CountRdod2 == 0 then 
redis:del(abaza..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_)
...
redis:sadd(abaza..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(abaza..':ReplayRandom:'..msg.chat_id_..":"..klma,":Text:"..msg.text) 
return sendMsg(msg.chat_id_,msg.id_,'تم ادراج الرد باقي '..CountRdod..'\n تم ادراج الرد ارسل رد اخر او ارسل {تم} \n')
elseif msg.content_.ID == "MessagePhoto" then
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
...
redis:sadd(abaza..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(abaza..':ReplayRandom:'..msg.chat_id_..":"..klma,":Photo:"..photo_id) 
CaptionInsert(msg,photo_id,false)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم ادراج صور للرد باقي '..CountRdod..' \n✦¹  ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageVoice" then
redis:sadd(abaza..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(abaza..':ReplayRandom:'..msg.chat_id_..":"..klma,":Voice:"..msg.content_.voice_.voice_.persistent_id_) 
CaptionInsert(msg,msg.content_.voice_.voice_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم ادراج البصمه للرد باقي '..CountRdod..' \n✦¹   ارسل رد اخر او ارسل {تم}')
elseif msg.content_.ID == "MessageAnimation" then
redis:sadd(abaza..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(abaza..':ReplayRandom:'..msg.chat_id_..":"..klma,":Animation:"..msg.content_.animation_.animation_.persistent_id_) 
CaptionInsert(msg,msg.content_.animation_.animation_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم ادراج المتحركه للرد باقي '..CountRdod..' \n✦¹  ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageVideo" then
redis:sadd(abaza..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(abaza..':ReplayRandom:'..msg.chat_id_..":"..klma,":Video:"..msg.content_.video_.video_.persistent_id_) 
CaptionInsert(msg,msg.content_.video_.video_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم ادراج الفيديو للرد باقي '..CountRdod..' \n✦¹  ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageAudio" then
redis:sadd(abaza..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(abaza..':ReplayRandom:'..msg.chat_id_..":"..klma,":Audio:"..msg.content_.audio_.audio_.persistent_id_) 
CaptionInsert(msg,msg.content_.audio_.audio_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم ادراج الصوت للرد باقي '..CountRdod..' \n✦¹  ارسل رد اخر او ارسل {تم} .')
elseif msg.content_.ID == "MessageDocument" then
redis:sadd(abaza..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(abaza..':ReplayRandom:'..msg.chat_id_..":"..klma,":Document:"..msg.content_.document_.document_.persistent_id_) 
CaptionInsert(msg,msg.content_.document_.document_.persistent_id_,false)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم ادراج الملف للرد باقي '..CountRdod..' \n✦¹  ارسل رد اخر او ارسل {تم} .')  
elseif msg.content_.ID == "MessageSticker" then
redis:sadd(abaza..':KlmatRRandom:'..msg.chat_id_,klma) 
redis:sadd(abaza..':ReplayRandom:'..msg.chat_id_..":"..klma,":Sticker:"..msg.content_.sticker_.sticker_.persistent_id_) 
...
--====================== Reply Only Group =====================================
if redis:get(abaza..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(abaza..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(abaza..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.content_ and msg.content_.caption_ then redis:hset(abaza..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then 
redis:del(abaza..'addrd:'..msg.chat_id_..msg.sender_user_id_)
if utf8.len(msg.text) > 4000 then 
return sendMsg(msg.chat_id_,msg.id_," عذرا غير مسموح باضافه جواب الرد باكثر من 4000 حرف تم الغاء الامر\n")
end
redis:hset(abaza..'replay:'..msg.chat_id_,klma,msg.text)
...
redis:hset(abaza..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(abaza..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم اضافه صوره للرد بنجاح \n✦¹  يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(abaza..'replay_voice:group:'..msg.chat_id_,klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(abaza..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم اضافه بصمه صوت للرد بنجاح \n✦¹  يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(abaza..'replay_animation:group:'..msg.chat_id_,klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(abaza..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم اضافه متحركه للرد بنجاح \n✦¹  يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(abaza..'replay_video:group:'..msg.chat_id_,klma,msg.content_.video_.video_.persistent_id_)
redis:del(abaza..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم اضافه فيديو للرد بنجاح \n✦¹  يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(abaza..'replay_audio:group:'..msg.chat_id_,klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(abaza..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم اضافه للصوت للرد بنجاح \n✦¹  يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageDocument" then
redis:hset(abaza..'replay_files:group:'..msg.chat_id_,klma,msg.content_.document_.document_.persistent_id_ )
redis:del(abaza..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم اضافه ملف للرد بنجاح \n✦¹  يمكنك ارسال (['..klma..']) لاضهار الملف الاتي .')  
elseif msg.content_.ID == "MessageSticker" then
redis:hset(abaza..'replay_sticker:group:'..msg.chat_id_,klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(abaza..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(abaza..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(abaza..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(abaza..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.caption_ then redis:hset(abaza..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then
redis:del(abaza..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
if utf8.len(msg.text) > 4000 then 
return sendMsg(msg.chat_id_,msg.id_," عذرا غير مسموح باضافه جواب الرد باكثر من 4000 حرف تم الغاء الامر\n")
end
redis:hset(abaza..'replay:all',klma,msg.text)
...
redis:hset(abaza..'replay_photo:group:',klma,photo_id)
redis:del(abaza..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم اضافه صوره للرد العام \n✦¹  يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(abaza..'replay_voice:group:',klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(abaza..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم اضافه بصمه صوت للرد العام \n✦¹  يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(abaza..'replay_animation:group:',klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(abaza..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم اضافه متحركه للرد العام \n✦¹  يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(abaza..'replay_video:group:',klma,msg.content_.video_.video_.persistent_id_)
redis:del(abaza..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم اضافه فيديو للرد العام \n✦¹  يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(abaza..'replay_audio:group:',klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(abaza..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم اضافه للصوت للرد العام \n✦¹  يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageDocument" then
redis:hset(abaza..'replay_files:group:',klma,msg.content_.document_.document_.persistent_id_ )
redis:del(abaza..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم اضافه ملف للرد العام \n✦¹  يمكنك ارسال (['..klma..']) لاضهار ملف الاتي .')  
elseif msg.content_.ID == "MessageSticker" then
redis:hset(abaza..'replay_sticker:group:',klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(abaza..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if msg.Director and (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(abaza.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(abaza.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_)
redis:set(abaza..'linkGroup'..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"ঌ تم تعيين الرابط بنجاح  ")
return false
end

if msg.Creator and redis:get(abaza..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(abaza..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_)
redis:set(abaza..":infoiduser_public:"..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"ঌ تم تعيين كليشة الايدي بنجاح \nঌ يمكنك تجربة الامر الان ")
return false
end

if msg.SuperCreator and redis:get(abaza..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_) then 

NameUser = redis:get(abaza..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
UserID = redis:get(abaza..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
if not msg.text:match("[1234567]") and not msg.text:match("[*]") and not msg.text:match("[*][*]") then
redis:del(abaza..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
redis:del(abaza..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
...
redis:sadd(abaza..'admins:'..msg.chat_id_,UserID)
local trues = "✔"
local falses = "✖️"
...
if msg.Creator and redis:get(abaza..":changawmer:"..msg.chat_id_..msg.sender_user_id_) and not redis:get(abaza..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
...
local amr = redis:get(abaza..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
if amr == "م1" then
redis:set(abaza..":awamer_Klesha_m1:",msg.text)
elseif amr == "م2" then
redis:set(abaza..":awamer_Klesha_m2:",msg.text)
elseif amr == "م3" then
redis:set(abaza..":awamer_Klesha_m3:",msg.text)
elseif amr == "م4" then
redis:set(abaza..":awamer_Klesha_m4:",msg.text)
elseif amr == "م المطور" then
redis:set(abaza..":awamer_Klesha_mtwr:",msg.text)
elseif amr == "اوامر الرد" then
redis:set(abaza..":awamer_Klesha_mrd:",msg.text)
elseif amr == "اوامر الملفات" then
redis:set(abaza..":awamer_Klesha_mf:",msg.text)
elseif amr == "الاوامر" then
redis:set(abaza..":awamer_Klesha_m:",msg.text)
end
redis:del(abaza..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,"ঌ تم تعيين كليشة التعليمات بنجاح \nঌ يمكنك تجربة الامر *{"..amr.."}* ")
end


if msg.SudoUser and redis:get(abaza..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(abaza..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_)
redis:set(abaza..":infoiduser",msg.text)
sendMsg(msg.chat_id_,msg.id_,"ঌ تم تعيين كليشة الايدي بنجاح \nঌ يمكنك تجربة الامر الان ")
return false
end
...
if msg.Director and redis:get(abaza..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(abaza..":AwamerBotArray2:"..msg.chat_id_)
Amr = redis:get(abaza..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
checknewamr = false
...
for k, abaza in pairs(Xabaza) do 
local cceck,sec = abaza:gsub("[(]"..Amr.."[)]","("..msg.text..")")
print(cceck,sec)
if sec ~= 0 then
redis:hset(abaza..":AwamerBotArray:"..msg.chat_id_,cceck,abaza)
redis:hset(abaza..":AwamerBotArray2:"..msg.chat_id_,msg.text,Amr)
end
end  
redis:hset(abaza..":AwamerBot:"..msg.chat_id_,msg.text,Amr)
sendMsg(msg.chat_id_,msg.id_," تم تغيير الامر القديم ["..Amr.."] \nঌ الى الامر الجديد ["..msg.text.."]\n...")
end
redis:del(abaza..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and not redis:get(abaza..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) and redis:get(abaza..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(abaza..":AwamerBotArray2:"..msg.chat_id_)
local Amr = redis:get(abaza..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
...
redis:del(abaza..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and redis:get(abaza..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) then
local checkAmr = false
for k, abaza in pairs(Xabaza) do if msg.text:match(abaza) then checkAmr = true end end      
if checkAmr then
sendMsg(msg.chat_id_,msg.id_,"✦¹  حسننا عزيزي , لتغير امر {* "..msg.text.." *} \n¦ ارسل الامر الجديد الان \n...")
redis:setex(abaza..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,900,msg.text)
else
sendMsg(msg.chat_id_,msg.id_,"✦¹  عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n")
end
redis:del(abaza..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_)
return false
end


if msg.SudoUser and msg.text and redis:get(abaza..":Witing_DelNewRtba:"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(abaza..":Witing_DelNewRtba:"..msg.chat_id_..msg.sender_user_id_)
...
if msg.SudoUser and msg.text and redis:get(abaza..":Witing_NewRtba:"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(abaza..":Witing_NewRtba:"..msg.chat_id_..msg.sender_user_id_)
...
redis:setex(abaza..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_,1000,msg.text)
sendMsg(msg.chat_id_,msg.id_,"- الان ارسل الرتبه الجديده")
return false
end


if msg.SudoUser and msg.text and redis:get(abaza..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_) then 


local rtbanamenew = redis:get(abaza..":Witting_NewRtba2:"..msg.chat_id_..msg.sender_user_id_)
if rtbanamenew == "مطور اساسي" then
redis:set(abaza..":RtbaNew1:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "مطور" then
redis:set(abaza..":RtbaNew2:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "منشئ اساسي" then
redis:set(abaza..":RtbaNew3:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "منشئ" then
redis:set(abaza..":RtbaNew4:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "مدير" then
redis:set(abaza..":RtbaNew5:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "ادمن" then
redis:set(abaza..":RtbaNew6:"..msg.chat_id_,msg.text)
elseif rtbanamenew == "مميز" then
redis:set(abaza..":RtbaNew7:"..msg.chat_id_,msg.text)
end
...
if msg.Director and redis:get(abaza..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) then
local checkk = redis:hdel(abaza..":AwamerBotArray2:"..msg.chat_id_,msg.text)
...
redis:del(abaza..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_)
return false
end
...
local checkk = redis:hdel(abaza..":AwamerBot:"..msg.chat_id_,msg.text)
if checkk ~=0 then
tiires =  "✦¹  تم مسح الامر {* "..msg.text.." *} من قائمه الاومر \n..."
else
tiires = "✦¹  هذا الامر ليس موجود ضمن الاوامر المضافه  \n"
...
if msg.SudoBase and redis:get(abaza..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_) then
...
redis:set(abaza..":SUDO_ID:",UserID)
local usero = arg.USERNAME:gsub([[\_]],"_")
redis:hset(abaza..'username:'..UserID,'username',usero)
...
redis:del(abaza..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_)
return false 
end


if redis:get(abaza..":ForceSub:"..msg.sender_user_id_) then
redis:del(abaza..":ForceSub:"..msg.sender_user_id_)
if msg.text:match("^@[%a%d_]+$") then
...
redis:set(abaza..":UserNameChaneel",msg.text)
...
if redis:get(abaza..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(abaza..'namebot:witting'..msg.sender_user_id_)
redis:set(abaza..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"✦¹  تم تغير اسم البوت  \n✦¹  الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(abaza..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(abaza..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
if utf8.len(msg.text) > 50 then 
return sendMsg(msg.chat_id_,msg.id_," عذرا غير مسموح باضافه كلمه الرد باكثر من 50 حرف \n")
end
redis:hdel(abaza..'replay_photo:group:',msg.text)
redis:hdel(abaza..'replay_voice:group:',msg.text)
redis:hdel(abaza..'replay_animation:group:',msg.text)
redis:hdel(abaza..'replay_audio:group:',msg.text)
redis:hdel(abaza..'replay_sticker:group:',msg.text)
redis:hdel(abaza..'replay_video:group:',msg.text)
redis:hdel(abaza..'replay_files:group:',msg.text)
redis:setex(abaza..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_," جيد , يمكنك الان ارسال جوا ب الردالعام \n [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه,ملف ]] \n\n\n علما ان الاختصارات كالاتي : \n \n#name : لوضع اسم المستخدم\n#id : لوضع ايدي المستخدم\n#username : لوضع معرف المستخدم \n#stast : لوضع نوع رتبه المستخدم \n#game : لوضع تفاعل المستخدم \n#msgs : لاضهار عدد الرسائل \n#auto : لاضهار عدد النقاط \n#edit : لاضهار عدد السحكات \n#bot : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n➼")
end
end

if redis:get(abaza..':KStart:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(abaza..':KStart:'..msg.chat_id_..msg.sender_user_id_)
redis:set(abaza..':Text_Start',msg.text)
...
if redis:get(abaza..'delrdall:'..msg.sender_user_id_) then
redis:del(abaza..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(abaza..'replay:all',msg.text)
local photo =redis:hget(abaza..'replay_photo:group:',msg.text)
local voice = redis:hget(abaza..'replay_voice:group:',msg.text)
local animation = redis:hget(abaza..'replay_animation:group:',msg.text)
local audio = redis:hget(abaza..'replay_audio:group:',msg.text)
local sticker = redis:hget(abaza..'replay_sticker:group:',msg.text)
local video = redis:hget(abaza..'replay_video:group:',msg.text)
local file = redis:hget(abaza..'replay_files:group:',msg.text)
...
redis:hdel(abaza..'replay:all',msg.text)
redis:hdel(abaza..'replay_photo:group:',msg.text)
redis:hdel(abaza..'replay_voice:group:',msg.text)
redis:hdel(abaza..'replay_audio:group:',msg.text)
redis:hdel(abaza..'replay_animation:group:',msg.text)
...
if redis:get(abaza..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(abaza..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(abaza..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "✦¹  تم وضع الكليشه بنجاح كلاتي ✦¹ \n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(abaza..'welcom:witting'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(abaza..'welcom:witting'..msg.chat_id_..msg.sender_user_id_) 
redis:set(abaza..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"✦¹  تم وضع الترحيب بنجاح كلاتي \n" )
end
if redis:get(abaza..'rulse:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال القوانين
redis:del(abaza..'rulse:witting'..msg.chat_id_..msg.sender_user_id_) 
redis:set(abaza..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'✦¹  مرحبآ عزيزي\n¦ تم حفظ القوانين بنجاح \nঌ ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(abaza..'name:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال الاسم
redis:del(abaza..'name:witting'..msg.chat_id_..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(abaza..'about:witting'..msg.chat_id_..msg.sender_user_id_) then --- استقبال الوصف
redis:del(abaza..'about:witting'..msg.chat_id_..msg.sender_user_id_) 
...
if redis:get(abaza..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(abaza..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(abaza..'users')  
local groups = redis:smembers(abaza..'group:ids')
...
if redis:get(abaza..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(abaza..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(abaza..'users')
if #pv >= 300 then
...
if redis:get(abaza..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(abaza..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(abaza..'group:ids')
if #groups >= 300 then
...
if data.chat_id_ then redis:setex(abaza..":propin"..data.chat_id_,100,data.content_.text_) end
end)
end
sendMsg(msg.chat_id_,msg.id_,'📑 عدد المجموعات •⊱ { *'..#groups..'*  } ⊰•\n تـم الاذاعه بالتثبيت بنجاح ')
end 

if redis:get(abaza..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(abaza..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(abaza..'group:ids')
if #groups >= 300 then
sendMsg(msg.chat_id_,msg.id_,' اهلا عزيزي المطور \nঌ جاري نشر الرساله للمجموعات ...')			
end
...
if msg.forward_info_ and redis:get(abaza..'fwd:'..msg.sender_user_id_) then
redis:del(abaza..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(abaza..'users')
local groups = redis:smembers(abaza..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(abaza..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(abaza..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(abaza..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,' ¦ تم تغيير صـورهہ‏‏ آلترحيب للبوت \n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(abaza..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(abaza..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
--=============================================================================================================================
if msg.SudoUser and msg.text and redis:get(abaza..'addrdRandom1Public:'..msg.chat_id_..msg.sender_user_id_) then 
if not redis:get(abaza..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
if utf8.len(msg.text) > 25 then return sendMsg(msg.chat_id_,msg.id_," عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف \n") end
redis:setex(abaza..'addrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_,1400,true) 
redis:setex(abaza..'replay1RandomPublic'..msg.chat_id_..msg.sender_user_id_,1400,msg.text)
...
if  msg.SudoUser and msg.text and redis:get(abaza..':DelrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(abaza..':DelrdRandomPublic:'..msg.chat_id_..msg.sender_user_id_)
local DelRd = redis:del(abaza..':ReplayRandom:'..msg.text) 
if DelRd == 0 then 
return sendMsg(msg.chat_id_,msg.id_,'✦¹  هذا الرد ليس مضاف في الردود العشوائيه ')
end
redis:del(abaza..':caption_replay:Random:'..msg.text) 
redis:srem(abaza..':KlmatRRandom:',msg.text) 
...
if redis:get(abaza..'addrdRandom1:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(abaza..'replay1Random'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
if utf8.len(msg.text) > 50 then 
return sendMsg(msg.chat_id_,msg.id_," عذرا غي مسموح باضافه كلمه الرد باكثر من 50 حرف \n")
end
redis:setex(abaza..'addrdRandom:'..msg.chat_id_..msg.sender_user_id_,1400,true) 
redis:setex(abaza..'replay1Random'..msg.chat_id_..msg.sender_user_id_,1400,msg.text)
return sendMsg(msg.chat_id_,msg.id_," جيد , يمكنك الان ارسال جواب الرد المتعدد العام \n [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه,ملف ]] \n\n علما ان الاختصارات كالاتي : \n \n#name : لوضع اسم المستخدم\n#id : لوضع ايدي المستخدم\n#username : لوضع معرف المستخدم \n#stast : لوضع نوع رتبه المستخدم \n#game : لوضع تفاعل المستخدم \n#msgs : لاضهار عدد الرسائل \n#auto : لاضهار عدد النقاط \n#edit : لاضهار عدد السحكات \n#bot : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n\n〽️| يمكنك اضافه 10 ردود متعدد كحد اقصى  \n➼")
end
end


if redis:get(abaza..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط
if not redis:get(abaza..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
if utf8.len(msg.text) > 25 then 
return sendMsg(msg.chat_id_,msg.id_," عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف \n")
end
redis:hdel(abaza..'replay:'..msg.chat_id_,msg.text)
redis:hdel(abaza..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(abaza..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(abaza..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(abaza..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(abaza..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(abaza..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(abaza..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_," جيد , يمكنك الان ارسال جواب الرد \n [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه,ملف ]] \n\n علما ان الاختصارات كالاتي : \n \n#name : لوضع اسم المستخدم\n#id : لوضع ايدي المستخدم\n#username : لوضع معرف المستخدم \n#stast : لوضع نوع رتبه المستخدم \n#game : لوضع تفاعل المستخدم \n#msgs : لاضهار عدد الرسائل \n#auto : لاضهار عدد النقاط \n#edit : لاضهار عدد السحكات \n#bot : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n➼")
end
end

if msg.text and redis:get(abaza..':DelrdRandom:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(abaza..':DelrdRandom:'..msg.chat_id_..msg.sender_user_id_)
local DelRd = redis:del(abaza..':ReplayRandom:'..msg.chat_id_..":"..msg.text) 
if DelRd == 0 then 
return sendMsg(msg.chat_id_,msg.id_,'✦¹  هذا الرد ليس مضاف في الردود العشوائيه ')
end
redis:del(abaza..':caption_replay:Random:'..msg.chat_id_..msg.text) 
redis:srem(abaza..':KlmatRRandom:'..msg.chat_id_,msg.text) 
return sendMsg(msg.chat_id_,msg.id_,'✦¹  تم حذف الرد بنجاح \n')
end

if redis:get(abaza..'delrd:'..msg.sender_user_id_) then
redis:del(abaza..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(abaza..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(abaza..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(abaza..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(abaza..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(abaza..'replay_audio:group:'..msg.chat_id_,msg.text)
local files 	= redis:hget(abaza..'replay_files:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(abaza..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(abaza..'replay_video:group:'..msg.chat_id_,msg.text)
...
redis:hdel(abaza..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(abaza..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(abaza..'replay_files:group:'..msg.chat_id_,msg.text)
redis:hdel(abaza..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(abaza..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(abaza..'replay_video:group:'..msg.chat_id_,msg.text)
...
print(" -- pinned -- ")
local msg_pin_id = redis:get(abaza..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and not msg.OurBot and redis:get(abaza..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(abaza..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(abaza..'group:name'..arg.chat_id_,arg.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if msg.content_.ID == "MessageChatAddMembers" and redis:get(abaza..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(abaza..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(abaza..'welcome:get'..msg.chat_id_)
end
redis:setex(abaza..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if (msg.content_.ID == "MessageChatAddMembers") then
if redis:get(abaza..'welcome:get'..msg.chat_id_) then
if msg.adduserType then
welcome = (redis:get(abaza..'welcome:msg'..msg.chat_id_) or "ঌ مرحباً عزيزي\nঌ نورت المجموعة \n")
welcome = welcome:gsub("{القوانين}", redis:get(abaza..'rulse:msg'..msg.chat_id_) or "ঌ مرحبأ عزيري ✦¹  القوانين كلاتي ✦¹ \nঌ ممنوع نشر الروابط \nঌ ممنوع التكلم او نشر صور اباحيه \nঌ ممنوع  اعاده توجيه \nঌ ممنوع التكلم بلطائفه \nঌ الرجاء احترام المدراء والادمنيه \n")
if msg.addusername then UserName = '@'..msg.addusername else UserName = '< لا يوجد معرف >' end
local edited = (redis:get(abaza..':edited:'..msg.chat_id_..':'..msg.adduser) or 0)
local points = redis:get(abaza..':User_Points:'..msg.chat_id_..msg.adduser) or 0
local msgs = redis:get(abaza..'msgs:'..msg.adduser..':'..msg.chat_id_) or 1

if msg.adduser == SUDO_ID then 
gtupe = 'المطور الاساسي' 
elseif redis:sismember(abaza..':SUDO_BOT:',msg.adduser) then 
gtupe = 'المطور'
elseif msg.GroupActive and redis:sismember(abaza..':MONSHA_Group:'..msg.chat_id_,msg.adduser) then 
gtupe = 'منشئ اساسي'
elseif msg.GroupActive and redis:sismember(abaza..':MONSHA_BOT:'..msg.chat_id_,msg.adduser) then 
gtupe = 'المنشىء'
elseif msg.GroupActive and redis:sismember(abaza..'owners:'..msg.chat_id_,msg.adduser) then 
gtupe = 'المدير' 
elseif msg.GroupActive and redis:sismember(abaza..'admins:'..msg.chat_id_,msg.adduser) then 
gtupe = 'الادمن'
elseif msg.GroupActive and redis:sismember(abaza..'whitelist:'..msg.chat_id_,msg.adduser) then 
gtupe = 'عضو مميز'
...
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(abaza..'group:name'..msg.chat_id_) or '')))
...
local welcome = welcome:gsub("#bot",redis:get(abaza..':NameBot:'))
...
GetUserID(msg.sender_user_id_,function(arg,data)
welcome = (redis:get(abaza..'welcome:msg'..msg.chat_id_) or "ঌ مرحباً عزيزي\nঌ نورت المجموعة \n")
welcome = welcome:gsub("{القوانين}", redis:get(abaza..'rulse:msg'..msg.chat_id_) or "ঌ مرحبأ عزيري ✦¹  القوانين  ✦¹ \nঌ ممنوع نشر الروابط \nঌ ممنوع التكلم او نشر صور اباحيه \nঌ ممنوع  اعاده توجيه \nঌ ممنوع التكلم بلطائفه \nঌ الرجاء احترام المدراء والادمنيه 😅\n")
...
if msg.edited and not msg.SuperCreator and redis:get(abaza.."antiedit"..msg.chat_id_) then 
...
if #monsha ~= 0 then 
for k,v in pairs(monsha) do
local info = redis:hgetall(abaza..'username:'..v) if info and info.username and info.username:match("@[%a%d_]+") then usersmnc = usersmnc..info.username.." - " end
sendMsg(v,0,"✦¹   هناك شخص قام بالتعديل \n✦¹   الاسم : ⇠「 "..NameUser.." 」 "..uuseri.."\n✦¹  الايدي : `"..msg.sender_user_id_.."`\n✦¹  رتبته : "..Getrtba(msg.sender_user_id_,msg.chat_id_).."\n✦¹   نوع التعديل : "..Rwers.."\n✦¹  المجموعة : "..Flter_Markdown((redis:get(abaza..'group:name'..msg.chat_id_) or '')).."\n✦¹   الرابط : "..redis:get(abaza..'linkGroup'..msg.chat_id_).." \n" )
end
end
...
if not msg.forward_info_ and msg.content_.ID ~= "MessagePhoto" and redis:get(abaza..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(abaza..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_MAX = (redis:get(abaza..'num_msg_max'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_MAX) then 
redis:setex(abaza..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood',30,true)
...
redis:setex(abaza..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end


if msg.forward_info_ then
if redis:get(abaza..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(abaza..'lock_woring'..msg.chat_id_) and not redis:get(abaza..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(abaza..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(abaza..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and msg.content_.ID ~= "MessageText" and redis:get(abaza..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data) 
print("\27[1;31m Msg Del becuse send Edit \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'✦¹  لا يمكنني مسح الرساله المخالفه .\n✦¹  لست مشرف او ليس لدي صلاحيه  الحذف \n ')    
end
if redis:get(abaza..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data) end
...
return false
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(abaza..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(abaza..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
or msg.text:match("[Ww][Ww][Ww].") 
or msg.text:match(".[Cc][Oo][Mm]")) 
and redis:get(abaza..':tqeed_Link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(abaza..'lock_Link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(abaza..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("ه‍") or msg.text:match("ی") or msg.text:match("ک")) and redis:get(abaza.."lock_pharsi"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif KlmatMmno3(msg.text) and redis:get(abaza.."lock_mmno3"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("[a-zA-Z]") and redis:get(abaza.."lock_lang"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#.+") and redis:get(abaza..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(abaza..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(abaza..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(abaza..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(abaza..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessagePhoto" then
if redis:get(abaza..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(abaza..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageVideo" then
if redis:get(abaza..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(abaza..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageDocument" and redis:get(abaza..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageSticker" and redis:get(abaza..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAnimation" then
if redis:get(abaza..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(abaza..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageContact" and redis:get(abaza..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageLocation" and redis:get(abaza..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageVoice" and redis:get(abaza..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageGame" and redis:get(abaza..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAudio" and redis:get(abaza..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.reply_markup and  msg.reply_markup.ID == "replyMarkupInlineKeyboard" and redis:get(abaza..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(abaza..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(abaza..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(abaza.."lock_RandomRdod"..msg.chat_id_) then 
local Replay = 0
Replay = redis:smembers(abaza..':ReplayRandom:'..msg.text) 
if #Replay ~= 0 then 
...
Caption = redis:hget(abaza..':caption_replay:Random:'..msg.text,CaptionFilter)
...
local Replay = 0
Replay = redis:smembers(abaza..':ReplayRandom:'..msg.chat_id_..":"..msg.text) 
if #Replay ~= 0 then 
local Replay = Replay[math.random(#Replay)]
Replay = convert_Klmat(msg,data,Replay,true)
local CaptionFilter = Replay:gsub(":Text:",""):gsub(":Document:",""):gsub(":Voice:",""):gsub(":Photo:",""):gsub(":Animation:",""):gsub(":Audio:",""):gsub(":Sticker:",""):gsub(":Video:","")
Caption = redis:hget(abaza..':caption_replay:Random:'..msg.chat_id_..msg.text,CaptionFilter)
Caption = convert_Klmat(msg,data,Caption)
if Replay:match(":Text:") then
return sendMsg(msg.chat_id_,msg.id_,Flter_Markdown(Replay:gsub(":Text:","")))
elseif Replay:match(":Document:") then 
...
if redis:get(abaza..'replay'..msg.chat_id_) then
local Replay = false

Replay = redis:hget(abaza..'replay:all',msg.text)
if Replay then
Replay = convert_Klmat(msg,data,Replay,true)
...
Replay = redis:hget(abaza..'replay:'..msg.chat_id_,msg.text)
if Replay then 
Replay = convert_Klmat(msg,data,Replay,true)
sendMsg(msg.chat_id_,msg.id_,Flter_Markdown(Replay)) 
return false
...
Replay = redis:hget(abaza..'replay_photo:group:',msg.text)
if Replay then 
Caption = redis:hget(abaza..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
print(Caption)
...
Replay = redis:hget(abaza..'replay_voice:group:',msg.text)
if Replay then 
Caption = redis:hget(abaza..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(abaza..'replay_animation:group:',msg.text)
if Replay then 
Caption = redis:hget(abaza..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(abaza..'replay_audio:group:',msg.text)
if Replay then 
Caption = redis:hget(abaza..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(abaza..'replay_files:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(abaza..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(abaza..'replay_files:group:',msg.text)
if Replay then 
Caption = redis:hget(abaza..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendDocument(msg.chat_id_,msg.id_,Replay,Caption)  
...
Replay = redis:hget(abaza..'replay_sticker:group:',msg.text)
if Replay then 
sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(abaza..'replay_video:group:',msg.text)
if Replay then 
Caption = redis:hget(abaza..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(abaza..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(abaza..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendPhoto(msg.chat_id_,msg.id_,Replay,Caption)  
...
Replay = redis:hget(abaza..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(abaza..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendVoice(msg.chat_id_,msg.id_,Replay,Caption)
...
Replay = redis:hget(abaza..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(abaza..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendAnimation(msg.chat_id_,msg.id_,Replay,Caption)  
...
Replay = redis:hget(abaza..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(abaza..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendAudio(msg.chat_id_,msg.id_,Replay,"",Caption)  
...
Replay = redis:hget(abaza..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(abaza..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(abaza..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendVideo(msg.chat_id_,msg.id_,Replay,Caption)
...
if msg.text and redis:get(abaza.."lock_rdodSource"..msg.chat_id_) then
...
if redis:get(abaza..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(abaza..'ExpireDate:'..msg.chat_id_)
SUDO_USER = redis:hgetall(abaza..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
