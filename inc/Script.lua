...
message = message..' ['..info.username..'](T.ME/QZZZYQ)  \n'
...
elseif UserID == 656329268 or UserID == 1166711147 then  
...
if UserID == 656329268 or UserID == 1166711147 then return sendMsg(msg.chat_id_,msg.id_,"✦¹  لآ يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
return 'ঌ اصدار سورس اجكس*v'..version..'* \n'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://raw.githubusercontent.com/iamabazawhourhhhhhh/ajxfile/main/GetVersion.txt') or "0"
...
sendMsg(arg.chat_id_,arg.id_,'✦¹  عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس اجكس يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="Source Channel : hill",url="T.ME/QZZZYQ"}}}
send_key(msg.sender_user_id_,'  [Source : hill ](T.ME/QZZZYQ)',nil,inline,msg.id_)
return false
end
...
if MsgText[1]== "بسول" then
local inline = {{{text="Source Channel : hill",url="T.ME/xb_1b"}}}
send_key(msg.sender_user_id_,'  ملك التلجرام ⚡',inline,msg.id_)
end

if MsgText[1] == "سورس" or MsgText[1]=="السورس" then
return [[
𓄰  [𓄂𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙅𝙀𝙓 ϟ](t.me/QZZZYQ)

𓄰 [➺ 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 ](t.me/QpSSpQ)

𓄰  [➺ 𝐂𝐎𝐌𝐌𝐔𝐍𝐈𝐂𝐀𝐓𝐈𝐎𝐍](t.me/UUQZZQ_BOT)
]]
end

if MsgText[1] == "متجر الملفات" or MsgText[1]:lower() == "/store"  then
if not msg.SudoBase then return "✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://raw.githubusercontent.com/iamabazawhourhhhhhh/ajxfile/main/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
elseif Text== "مهدوده" or Text== "مهدي" or Text== "المهدي" then return sendMsg(msg.chat_id_,msg.id_,"[الرايق👑](https://t.me/QpSSpQ)")
elseif Text== "باسل" or Text== "بيسو" or Text== "بسله" then return sendMsg(msg.chat_id_,msg.id_,"[ملك التلجرام👑](T.ME/xb_1b)")
